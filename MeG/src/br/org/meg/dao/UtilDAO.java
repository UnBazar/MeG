...
public class UtilDAO {
	...
	public String getNomeEstado(int id) {
		try {
			...
			throw new DAOException("Erro ao buscar o nome do estado no banco de dados", this.getClass().getName());
		}
	}
	...
	public String getSiglaEstado(int id) {
		try {
			...
			throw new DAOException("Erro ao buscar a sigla do estado no banco de dados", this.getClass().getName());
		}
	}
	...
	public int getIdEstado(String nome) {
		try {
			...
			throw new DAOException("Erro ao buscar a id do estado no banco de dados", this.getClass().getName());
		}
	}
	...
	public String getNomeSecao(int id) {
		try {
			...
			throw new DAOException("Erro ao buscar o nome da secao no banco de dados", this.getClass().getName());
		}
	}
	...
	public int getIdSecao(String nome) {
		try {
			...
			throw new DAOException("Erro ao buscar o id da secao no banco de dados", this.getClass().getName());
		}
	...
	public String getNomeDescricao(int id) {
		try {
			...
			throw new DAOException("Erro ao buscar o nome da descricao no banco de dados", this.getClass().getName());
		}
	}
	...
	public int getIdDescricao(String nome) {
		try {
			...
			throw new DAOException("Erro ao buscar o id da descricao no banco de dados", this.getClass().getName());
		}
	}
	...
	public float getSalarioMinimo(int ano) {
		try {
			...
			throw new DAOException("Erro ao buscar o ano no banco de dados", this.getClass().getName());
		}
	}
	...
	public void adicionaHistorico(int id) {
		try {
			...
			throw new DAOException("Erro ao adicionar no historico!", this.getClass().getName());
		}
	}
